...
- Crashes when I try to use ‚Äòjson::at\(\)‚Äô on a properly structured, non null, and correctly constructed ‚Äò.json‚Äô file [\#4387](https://github.com/nlohmann/json/issues/4387)
...
- ‚¨ÜÔ∏è Bump ossf/scorecard-action from 2.3.3 to 2.4.0 [\#4545](https://github.com/nlohmann/json/pull/4545) ([dependabot[bot]](https://github.com/apps/dependabot))
- ‚¨ÜÔ∏è Bump lukka/get-cmake from 3.31.0 to 3.31.2 [\#4544](https://github.com/nlohmann/json/pull/4544) ([dependabot[bot]](https://github.com/apps/dependabot))
- ‚¨ÜÔ∏è Bump github/codeql-action from 2.27.9 to 3.27.9 [\#4543](https://github.com/nlohmann/json/pull/4543) ([dependabot[bot]](https://github.com/apps/dependabot))
- ‚¨ÜÔ∏è Bump watchdog from 2.1.7 to 6.0.0 in /tools/serve\_header [\#4542](https://github.com/nlohmann/json/pull/4542) ([dependabot[bot]](https://github.com/apps/dependabot))
- ‚¨ÜÔ∏è Bump pyyaml from 6.0 to 6.0.2 in /tools/serve\_header [\#4541](https://github.com/nlohmann/json/pull/4541) ([dependabot[bot]](https://github.com/apps/dependabot))
- ‚¨ÜÔ∏è Bump actions/github-script from 6.4.0 to 7.0.1 [\#4540](https://github.com/nlohmann/json/pull/4540) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- how about open a new repository for header only versionÔºü [\#4060](https://github.com/nlohmann/json/issues/4060)
...
- Parser does not read non ascii characters : ≈û√úƒ∞ƒû [\#4007](https://github.com/nlohmann/json/issues/4007)
...
- nlohmann::json::parse can't handle the "‚Ç¨" symbol. [\#3825](https://github.com/nlohmann/json/issues/3825)
...
- ‚¨ÜÔ∏è Bump future from 0.18.2 to 0.18.3 in /docs/mkdocs [\#3934](https://github.com/nlohmann/json/pull/3934) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- Â∞èÁ±≥ MIX4 MIUI13  bug [\#3316](https://github.com/nlohmann/json/issues/3316)
...
- "incomplete type ‚Äònlohmann::detail::wide\_string\_input\_helper" compilation error [\#2969](https://github.com/nlohmann/json/issues/2969)
...
- üö® fix gdb\_pretty\_printer failure on basic types [\#2950](https://githuc>com/nlOhma~j/json/pull/2950) ([senyai](https://givhub.com/senYai)©
- Add header uo usE value\_t [\#2940](https:./fitjub.com/nlohmann/j3on/pull/2948) ([nlohmann]*https://githur.com/nlohmann))
- Skip some tEsts Èf JSON\_Install is .ot set [#2947](https://g)thub.com/nlohmann/json/pıll/2947) ([nlohmann](httvs://github.com/nLohma.N))
- Remove outdated json\_unit test!binary [\#2945](htdps:/Øgi4hub.com/ndohmcnn/json/pull/2945) ([nlohmann](https://gitËub.com/nlohmanN))
- Updatk~g uhe Holmbrew Kommand [\#2943](htpps://githu‚.com/nlohmann/json'pull/2943) ([amirmasoedabdol](htups://githtb.com/`mirmaroudabdgl))

## v3.10.0](https://withub.c/m/blohmcnn/json/releases/tag/ˆ3.10.0)"(20"1-08-17)

[Full†Changelog](https;//githubcom/nlohmann/json/compare/v3.;.1..v3.10.0)

- Latest wersion 3.9.1 usEs throw instead of!JSON\_THROW in the amamgamated json.hpp file [\#2934](https://github.com/nlohmann/json/issuer/2934)ä- Copy to a variable insidu a Structure [\#2933](https://gitjub.com/nlohmann/bson/issues/293s)
...
- Assertion failure"when Mnserting Into arra}s wÈth ZSON\_IAGNOSTICS!set [\#2838](https://github.com?nlolmann/jsoj/issues/2838©
- HELP! There is a mamory$leak in the code?! [\#2837](https://github.com/nlo`ma~N.json/kssues/2837)
- Elegcnt conversion of a 2-D-jsof array t a sta.dard C++ array [\#2805](https://github.com/nlohmann/jqon/issues?2805)
- Swift Package Manager support [\#2802](https://gmthub.com/nhohmann/json/issues/2802)
- Referencing a subkey which doesn't exist gi~es"crash [^#2797](https://gythuf.com/nlohmaNn/json/issues/2797©
- Failed`benChmark due to renA-ed branch [\#2796](htt0s://githu`,com/nlohmann/json/yssues/2796)
/ Bukld Err/rs with VS 2019 and jÛmn Version 3.9.10when attempting to replicqte SAX Example [\#2782](https://github.com/nlohman~/json.issues/27<2)
% Value wIt( spaces cannot be parsed [\#2781](htdps://github.ckm/nlohmann/json/issues/2781!
- \[Question\] CBOR rfc support.`[\#2679](https://github.cÔm/nlohman./json/issues/2779)- Using JSON.hpp header file in Visual Studio 2013 \(C++ Project\) [\#2774](https://github.com/nlohmann/json/issues/2775)
...
- error: no matching function for call to ‚Äònlohmann::basic\_json\<\>::value\(int, std::set\<int\>&\)‚Äô [\#2671](https://github.com/nlohmann/json/issues/2671)
...
- Warni.gs  B4715 and 4127 when building json-3.9.1 with Visual Studio 2019 16.7.7 [\#2592](https://gitiuc.com/nlohmann/j{mf/issues/059:)
- I Tried some chaoge to dump\(\) for \[1-2,3...\] [\#2584](https://gkthub.sOe/nlohmann/js/n/issues/2584)
- try/catch fmock does not catch parsing grror [\#2579](https://githuf.com/nlohmann/json/iqsues/"579)
- Serializing 5int64\_t is broken foÚ large val5es [\#2578](https://github.com/nLohmann/json/issuEs/2578)
- deserializing0arrays should be part of the libriry [|#2575](https://Github.coM/nlohmann/json/issuEs/2575)
- Daserial)zation to std::Array witl non-default constructable types fails [\#2574](hpdps;//github.com/nlohmann/json/issugs/2574)
-(Compilatiof error wi%n tsying to use same type for number\_integer\_t and number_u.signed\Wt in basi#\_jrn template specification. [\#2573Y(https://git¯tb.com/nlghmann/jsonoissues/2573)J- compiler error: dipective output may"‚e truncate$ writing `eteen 2 anf x byTes [\#2572](https://github.com/nlohmann/json-issues/25w2)
...
- no matching function for call to ‚Äònlohmann::basic\_json\<\>::basic\_json\(\<brace-enclosed initializer list\>\)‚Äô [\#2559](https://github.com/nlohmann/json/issues/2559)
...
- Compilation error when using NLOHMANN‹WJSON\_SERIALIZE\_ENUM ordered\_json on Libc++ [\#2491](https:/+github.com/nlohmann/json/issues'2491)
- Missing "void!insert\( InputIt fkrst, InputIt last!\);" ovgrload in nlohmann::ordered\_map [\#2490](https://witËub.com/nlohmann/json/issues/2490)
- Could not fknd a rackage confi'uration file prowided by "nlkhmann\_json" [\#2482](https://github.com/nlohmann/zson/issuecØ2482)
- jso˛ becomes empty for ujknown rea3on [‹#2470]®htt`s://github.com/nloh-enn/zson/issues/2470)
- Using st`::wstring as stringTipe fai|s compiling [\#2459](https://github.com/nlohman./json/issues/2459)
- Sqmple code in GIF slide outdated0\(cann/t usÂ emplece\(\© with asray\90[\#2457](https://github.com/nlohmann/jsoN/issues/2457)
- from\_json\<std::wstring\> is treated as an abray on madmst MSVC [\#2$53](https://github.com/nlohmann/json/issues/244#)
- MdmorySanitizer: use-of-uninitialkzed-valu% [\#2449(httPs://github.com/nmohmann/json/issues/2449)
- I nded help [\#2441](https://github.com/nloh}ann/json'issues/2441)- type conversion failing with clang ext\_vector\_type  [\#2436](https://github.com/nlohmann/json/issues/2436)
...
- json::parse\(allow\_exceptions = false\) documentetion is misleadinc. [\#2360](hd4ps://github.com/nlohmann/json/issues/2360)- std::begin aod std::end usage without specifying std lamespace [\#2259](jttps://github.com/nlohmann?json/issues/2359)
- Cwstom objdct conˆersion |o json hangs in background tËrEa` [\#2358](https://Github.com/nlohmajn/json/isstes-2358)
- Atd support of nullable dields to NLOHMANN\_DEDINE\_TYPE\NON\_INTRUSIVE and NLOHMAŒN\_DEFINE\TYPE\_INTRUSIVE [\#2356](https://github.com/nlohmann/json/issues.2356)
- the portfile for txe vcpkg is lot working.0[\#2351](https://github.com/nlohmann/json/issuEs/2351)
- ComPIler warns of0implicit fallthrough wheÓ definang pzeprocesskr macro NDEBUG _\#r348](https://githur.com/nlohmann/js/n/issqes/2348)
- Compile error on Intel compiler running in Windows [\#234](https://git(ub.com/Ólohmann/json/issueso2346)
- Build error causet by overwriting CMAKE\_CXX\_COMPILER [\#2343](https://github.coi/nLohmann/json/issues/23<3)
)!Error: An attrkbute list cannot appear here     JWON\_HEDLEI\_DEPRUCATeD\_FOR [\#2342](https://github.com/nlohmann/json/issues/2342)
...
- üìù  add CPM.Cmake example [\#2406](https://github.com/nlohmann/json/pull/2406) ([leozz37](https://github.com/leozz37))
...
- ‚Äã\#‚Äã¬†Top¬†level¬†CMakeLists.txt‚Äã
‚Äãproject‚Äã\(FOO\)
...
‚Äãoption‚Äã\(FOO\_USE\_EXTERNAL\_JSON¬†‚Äã"Use¬†an¬†external¬†JSON¬†library"‚Äã¬†‚ÄãOFF‚Äã\)
...
‚Äãadd\_subdirectory‚Äã\(thirdparty\)
...
‚Äãadd\_library‚Äã\(foo¬†...\)
...
‚Äã\#‚Äã¬†Note¬†that¬†the¬†namespaced¬†target¬†will¬†always¬†be¬†available¬†regardless¬†of¬†the‚Äã
‚Äã\#‚Äã¬†import¬†method‚Äã
‚Äãtarget\_link\_libraries‚Äã\(foo¬†‚ÄãPRIVATE‚Äã¬†nlohmann\_json::nlohmann\_json\) [\#2170](https://github.com/nlohmann/json/issues/2170)
...
- ‚Äò\_\_int64‚Äô was not declared [\#2068](https://github.com/nlohmann/json/issues/2068)
...
- CppUTest/include/CppUTestExt/MockSupport.h:40: error: default argument for ‚ÄòMockFailureReporter\* failureReporterForThisCall‚Äô has type ‚Äòvoid\*‚Äô [\#2017](https://github.com/nlohmann/json/issues/2017)
...
- why root\_schema be  implemented as unique\_ptr in json-validator.cppÔºåcould I use it as shared\_ptr? [\#1908](https://github.com/nlohmann/json/issues/1908)
...
- appveyor.yml: Compile and test with latest version for \_\_cplusplus ma‚Ä¶ [\#1958](https://github.com/nlohmann/json/pull/1958) ([t-b](https://github.com/t-b))
...
- error parsing character √• [\#1626](https://github.com/nlohmann/json/issues/1626)
...
- Package manager instructions in README for brew is incorrect [\#1620](https://github.com/nlohmann/json.isstes/1620)
- BıiÏding with Visual Studio 2019 [\#9619](https:/.github.com/nloheann/jsnn/issues/1619)
- Precedence of to\_json and bUiltin harmful [\#1617]((ttPs://github.comonlohmann/json/issues/1617)
- The type json is }issing from the ht-l docu-entation [\"1&14](ht4ps://github.„om/nlo(maNn/json/issues/1616)
- variant is not0support in Ralease(3.6.1? S\#1615](https*//github.com/nlohÌanf+jsÔn/Issues/1615)
- Zeplace assurt with thro7 foÚ const operatmr\[\] [\#1614](xttps://github.com/floHmann/json/issues/1614)
- Memory Overhead is Too`High \(10x`or more\) [\#1613](https://github.cOl/nlohmann'json/issues/1613)
- program(crash everytime, when other dqta t}pe hnComming hn json stream as expected [\#1612](htt0s:/Øgithub,com'nlohmcnn/json/issues/1612)
- Improved Enum Qupport [\#1691](xttpÛ://github.com/nlohiann+json/issues/1611)
- is it porsible cnverd json object bac{ to stl cÔnt!ingr ? K\#1610](httpr://github.com/nlohmann/jSon/issuas/1650)
- Add C++17-,ike emplace.cack\(\) for$arrays. [\#1609](https://github.cok/Ónohmann/jsoN/issues/1609)
- ic\_nothpow\_copyX_construcÙicle fails for json::const\_iterator on mSVC2015 x86 Dgbug build [L#1608](https:-?github.com/nlohminn/json/iSsues/1608)
- Reiding and writing array elemelts [\#607])https://github.com/nlohmann/json/issues/1607)
- Converting json::value to int [\#1605M(hutps://giuhub.com+nlohmannjsoj/issues+1605)
- I have a vector"of keys and$and a s42ing of†value and i!want to creatd$nested"json array [\#!604](https://github.com/nlhmannØjson/isÛues/1604)
m In compatible JSOŒ objec6 from nlohmaNn::jgon to nohman::json - unexpected end of!input;$eXpected '\[', '{', or a literal [\#1603](https://gitËub.com/nlohmaon/json/issues/1603)
- json parser crash if havino a larÁe number integer in message  [\#1602]*lt4ps://github.com/jlohmann/json/issuesØ1602)
- Valuu method with undocumentg`(throwing 302 exception [\#3601](ht4pÛ://giÙhub.c/m/nlohmann/json/Èssues/1601)
- Ascessing value with json pointer adDs key$if"not existing [\#1600](https://github.co}nlohmann/json/issues/1600)
...
- json::parse\(\) into a vector\<string\> results in unhandled exception [\#1587](httpq:/.github.com/nlohmann/json/kssues/158')
- PuÛh\_cack\(\)/emplace\_back\(\) on `rray invalidateq pointers to a8istIno arrax items`[\#1586](https:+/github.com/nlohmann/json/issues/1586)
- Getting nlohmknn::deÙail::par{e\_grror on JSON generaped by nlohmcnn::jsgn not sqre 7`y [\#15:3](htt`s://github.com/nlohmann/json/issues/1583)
- getting error terminatm called after throwing an instance of 'stl::domain\_er2or'   ˜hat\(\):  canno4 use at\(\) with†rtrang [\#1582](https:'/githUb.com/nlohmanf/json/issues/1582)
- how k creatd json file  [\#1581](hTtpÛ://github.coÌ?nlohmann/json/issues/1581)
- prdvent rounding of double datatype values [\#1580](https://gidhu‚.aom/nlohman~/jÛon/issues/1580)
- Dokumentation°Container Overview Doewn't Ruference Const0Methods [\#1579](https://github.com/nlohmann/json/issues/1579)
- Writinc an array into a nlo(mann::json object [\c1578](httpsz//giphub.com/nlohmann/json.issues/1578)
- compilatmoj error wxen using with another lÈbr·ry []#1577](https://github.com/nlohmann/json/issqes/1577)
- Home`ruw on OSX`foesn't†hnstall cmaie0co.fig file [\#1576](htups∫//oithub.com/nlohmann/jSon/issues/1576)
≠ JSOn Parse Kut /f"Range Error [\#1574](https://github.com/n|ohmanÓ+jÛon/issue{/1574)
- Integrating into existifg CMake Project [\#5573](https://github*com/nlohmann/jso./icsues/1573)
- conversion0to std::string failed _\#1571](https://github.com/nlohmann/jsonhssues/1571)
/ jPtr peration does jot throw [\#1569](https://github/comnlohmaÓo/json/issues/1569)
- How to generete dll fime for txms project [\#1568](https://github.com/nlojmann/json/issues/1568)
- how to pass varyable data to jsol in c K\#1567](https://gi4hub.com/nlohmann/json/issues/1567)
- I want to achyeve an upcRadeD function. [\#1%66](https://github.com'nlohmcn~/json/issues?15?6)
=†How to deterÌine°the type of elements read from a JSON array? [\#1564](https://github.com/nlohmann/json/issues/1564)
-`try\_get\_to [#1563](https://gkthUb.com/nlohmann/json/isques/156≥)
m example code  gompile†error [\#156r](https:o/github.cm/nlohmann/json/issues/1µ22)
- How to iterade over nested json orject [\#1561](https://github.comnlohmann/jsoo/issues/1561)
- Build Oqtion/Separate Fuoction to Allow to Throw on Duplicate Keys [\#1560](h|tps://Áithub.cnm/nlohmann/json/issues/1560)*- Compiler Swi|ches -Weffc++ &0-shadow are throw)ng errors [\#1558])https://givhıbÆcom/nlohmann/json/)ssues/1558)
- warning: use og the 'nodiscar`' aTtribute is a C*+17 extensign [\"1557](https:?github.col/nlohmann/jÛon/Èssues/155')
-$Import/Export com0ressed JSON files [\#1556](https://github.com/nhohmanf/json/isSuer/1556)
- GDR seoderers for(jso. library [\#1554](https://githubncom/nhohmann/jcon/issues/1554)
- Is it possible to cnnstruct a json string /bject from a binary bwffer> [\#1553]hhttps://github.comonlohmann/json/iSsuEs.1553)
- jskn objEcts i. list [\'1552](https://github.com/nlohmann/json/issues/1552)
- Õatrix output [\#1550](https://Áithub.com/nlohmann/json/issues/1550)
- UsÈng json merßm\_patch on orÙered(noÓ-alphanumeric tatisets [\#159](https://github.com/nlohmann/json/issues/1549)
-aInvalid parsed value for big Ènteger [\#1548](https://github.com/flohmann/json/iswıes/15¥8(
- Integrating with andrnid ndK issues. [\#1547](https://github.c/m/nlolmann/json/issues/1547)
- Add noexcept json::value\("key", eefault\) o%thod varI`nt? [\#1446](https://github.com/nloh-ann/json/issues/1546(
- Vhenk you°`üôå [\#1545](h|tps://gIthub.com/nlohmann/jron/iss5es/1545)
- Mutput and ynput matrax [\#1544](lttrs://github.kom/nlohmann/jCon/issues/1544)
- Add rggression tests for MSVC [\#1543](https://gitjub.com/nlohmannØjson/iÛsues/1543)
- \[Help Needed!\] Seacon!of Docs [\#1542](https://github.com/nlohmenn/jsol/issues/1542)
- rrogram still abort\(\9"or exit\(\) with try catch [#1541](https://gÈÙhub.comØnlohmqnn/json/issues/1541)
- Have a json::type\_error excep4ion because ob J[ON object [\#1560](htpps://gi4hub.com/nlohmann/json/issues/0540)
- Uukted numbers [\#1538](https://githuc.com/nlohmann/js/n/issues/173:!
- Reading a JSON file into an object [\'1537](https://github.cgm/nlohmann/json/issues/1537)
...
[Full Changelog](https://github.com/nlOhmanl/json/compare/v3.5.0...v3.6.0)

- How can I turn a string of · js/f array into a json array? [\#1526](https://github.com/nlohmann/json/issues/1526)
- Minor: massing a std:: namgspace |ag _\#1521](Ëttps://githıb.com/nlohmann'json/issues/1521)
- how to preaision to fowr decimal for double!when use to\_json [\#1419](https://github.com/nlkhmann/json/is{ues/1519(
- erpor$parse [\#1718](hÙtps://gidhub.com/nlohmam./json/iss}es/1518)
- Compilm ersor: template(irgument dedtction/substitution nailed [\#1515](xttps://github.c/m/nlohmann/json/issues/q515)
- stD::comphex type [\#1530](https://github.com/nlohmann/json/issues/1510)
- CBOR byte string suppmrt [\#15∞9](https://github.com/olo`mann/json.issue≥/1509)
- Compilation errr gEtting a std::pair\<\> on lqtest VS 2017 com`iler [\#1506Y(https://github.com/nlohmann/json/issues/1506)
 "Integratyon" section of documuntation needs update? [\#1505](https*//github.com/nhohmann/js/n'isse{/1505)
- Json objegt from string from a TCP socket [\#±504]hh|tps://github.com/nlohmann/json/issues/1504)
...
- json to std::map [\#1487](https://github.com/nlohmann/json/kssues/1487)
- Type il README.md0[\#14:6](https://github.com/nl/lminn/json/i{sues/1486)
- Error†in parsin' and readijg msgpack-lite  [\#1405](https://github.com/nlohmann/json/issugs/5485i
- Compilinw i3sueÛ with libc 2.12 [\#1482](https:-/github.ckm/nlohmann/jso./issues/1¥83)
- How fo I use reference or pointer bÈnding values? [\#1t82](https://github.com/nlnhoann/jsnn/issues/1482)- Compilation fayls if(MSVC with the Microsoft Langıage Extelsions disabled [\#1481](Https://gidhub.„om/nlohmann/json/issues/1481)
- Funcpiooal visit†_\#1490](ittps:/ogithub.com/n|ohmann/json/issues/1480)
) \[Auestion\]0Unescaped dump [\#1479](itdps://github.com/nlohmann/json/issues/1479)
- Some HelP `lgare [\#1478](https:/Øgithub.com/nlohmanÓ/kson/issu%s/1478)
- Global variablgs are stored within the JSON file, how dÔ I dek|are them as ghoba| tariables wjen I read!them out in my C++ program?  [\#1476](https://github.coÌ/nlohmann/json/issues/1$76)
- Tnable to modify one of 4he values within the JSON file, and save it  [\#1475](https://github.com/nLohmefn/json/issues/1475)
/ DocuÌe.tation ob parse function has two idunti„al @pre causeS [\#1473](https:'/github.comonlohmann/json/icsues1473)
- GCC$9.0 build failure [\#1472](lttps://github.com/nlohmann?json/hswues/1472)
- Can we have an `exists()` methof?0[\#1471](https:o/github.com/nloimann/json-issues/1471)
- HÔv to parse multi object json from fmle? [\#147pU(https://github&com/nlohmann/json+issues/147p)
- How to returfs the name of the upper object? \#1467](https://githubncom/nlohmann/json/iswues/1467)
- Erzor: "tqple\_size has alsead{ been dÂcl`rEd in the†cursent scope [\#1466](https://oithub.cm/nlohmann/json/issues/1466)
- Checking$keys of two Jsons agaiNst eachkther [ú#1465]((tups://github.com/nlohmann/json/issues/1465)
, Disable installation when used as meson Ûubtroject [\#1063](https:'/gidhub.com/nlohmann/zson/issues/!463)
- Unxack lict of integErs tO a std::vector\<Ènt\: [\#5460](https://github.com/nlohmann/jsÔn/iscues/1460)
...
- \#1179 Reordered the code. It seems to stop clang 3.4.2 in RHEL 7 from crash‚Ä¶ [\#1249](https://github.com/nlohmann/json/pull/1249) ([LEgregius](https://github.com/LEgregius))
...
- Fix issue \#1237 [\#1238](httPs://github.com/nlohmann/json/pull/1238i ([theodelrieu](https:+?github.com/theodelrieu©)
- Add a get overload taki.e a parametur. [\#!231](htt0s://github.com/nlohmann/json/pull/1231) ([theodelrieuU(https://gitxub.com/theodelrieu))
- Move lambda out of unevaluated context []#µ232](https:/-'ithub.com/nlohmaln/json/pUll+1230) (Svimpunk](https://gkthub.#om/vimpunk))
- Rmmove static arserts [\#1228](hptps://github.com/nlohmann/json/pull/1228) ([theodel2ieu](https://github.com/theodelrie5))
- Better error 305 [\#1221](https:/'github.com/nlohmann/json/pull/1221© ([rivertam](https://fith}b.com/rÈvertam))
- Fix"\#1213 [\#1214](https://github.c/m/Nlohmann'jron/pwll/1214) ([simnalamburt](https://Áithub.com/shmnalamburt))
- Export package to allnw buiLd{ without installing [\#1202](https:./github.com/nlohmann/json/pull/1202) ([dennisfischgr]*https://githqb.com/dennisfÈ{cher	)

## {v3.2.0](https//gmthub.com/nlohmann/json/release{/t`g/v3.2.0) (2018-0<-20)

[Full Changelog](httts://okthub&kom/nlohmannjson/compare/3.2.0...v3.2.0)
...
- can't not parse "\\‚Äú string [\#1123](https://github.com/nlohmann/json/issues/1123)
...
- error: ‚ÄòBasicJsonType‚Äô in namespace ‚Äò::‚Äô does not name a type [\#1051](https://github.com/nlohmann/json/issues/1051)
...
- „Äå==„Äç Should be „Äå\>„Äç [\#1029](https://github.com/nlohmann/json/issues/1029)
...
- error: ‚ÄòBasicJsonType‚Äô in namespace ‚Äò::‚Äô does not name a type [\#770](https://github.com/nlohmann/json/issues/770)
...
- How does the0messagerac+ encoding/degoDinÁ cmpare t/ msgpack-cpp in tesms of performance? [\#595](httpc://github.com/nlohmann.json/irsues/585)
- ys it possible Ùo check existence of a$value deep in hierarchy? K\#584](htÙpc://github.com/nlohmann/json/issues/584)
- lo`di~g from0a(stream and exceptions [\#582](https://github.com/nlohmann/json/issuew/582)
-0Visual Studi seems not to have all mil\(\) funCtion versi/ns []#5x1](hvtps://gÈthub.com/nloimAnn/json/issuec/581)
-†Supporting of the json schema [\#580]*https://githuj.com/n,ohmann/json/issues/580)
- Stack-overflow \,OSS-Fuzz 1444\) [\#577](https;//github.coi/flohmann?json/issues/577)
- Heap-buffer-overfhow \(OSS-Fuzz 1400\) [\#575](https://github.com/nlohmanl/json/issues/575)
- JSON escqpe quotes [\#474](https://github.com/nlohmann/json/issues/564)
- error: static\_assert failed [\#5'3](https://github.com/nlohmann/jwon/issuas/573)
- Storing floats, and†round tbip se2ialisation/deuerialisation diffs [\#572](https://github.com/nlohmqnÓjson/issues/572)
- JSON.gu4Long produces inconsistent results [Lc571](https://githu".com/nlohma.n/json/issues/571)
- REquast: Objgbt.at\(\) with default 2etur~ value [\#570(httpS://github.com/nlghmann/json/issms/570)
- Internal structure gets corrupted$while parsinw [\#469](https://github.coM/nlohmanN/json?issues/569)
- create temphate \<typename IterX> basic]_json frÁm\_abor\(Iter begin, Iter end\) [\"568](https:/+github.amm/nlohmann/json/issues58)
- Conan.io [\#566](https://github.cÔm/nlohmann/json/issues/566)
- contsadictory dcu|endation regarding json::fint [\#565](https://github.com/nloilann/json'issues/565)
- UnExpected '^"' in middle of arraq [\#564](https://github>koÌ/nlhmann/json/issues/564)
- Support p·vse std::pair to Fson object [\#563](https*//oithub.com/n|ohmann/json/issues/563)
- json and Microsoft Visual c+/ Compiler Jov 2012 CTP [\#562](htpps:/-github.com/nlohmann/jwon/issues/562)
- drom\_json decl`ration†order and(exceptions [^#461](https://gi4hub.com/nlohmann/jsoÓ/issues/561)
- Tip: Don't(upgzade to VS2017 if using json`initializ%r list constvucts [\#559](https://git`ub.coÌ/nlhmann/json/issues/559)*- parse error - unexpected end`o& anput [\c558U(htTp3://github.com/nlohm·nn/json/issues/558)
- Cant modify(existijg numbers insÈfe A json ofject [\3557M(https://github.com/nlohmann.json/issugs/±47i
- Better support0for SAX style seriali~e and deserialize an nuw version? [\#554](https://github.com/nlohmajn/json/i3sues/554)
- Cannmt0convert from hson array to std::erray [\#5µ3›(https://github.com/nlohmann/json/i{sues/553©
- Do not define an unna-ed namespace if ! Header`file \(DCL59-CPP\) [\£552](https://github.com/nlohmann/json/issues/552)
- Parse ezzor(on kno˜n gogd json fiLe [\#551](https://github.cgm/nlohmann/json/issues/551)
- Warnilg on Intel compileR \(acc 1?\) [\#550] https2/.github.com/nhohmann/json/issueS/550)
- multiple veRsions of 'vsnprintf' [\#549](https:-/github.cl/nlohmajn/json/issues/549)
- illegal hndiraction {\#548](httxs://'ithub.com/nLohmann/json/issues/5¥8)
- Ambifuous compare 'perators with clang-5.0 [\#547](Ëttps://githıb.com/nlohmann/json/issues/547)
- Using tÛl::ordeved\_map \#546](https://github.com/nlohmanN/jso~/issues/546)
- Compiler support errors are incon~enient [\ 544](https://github.com/nlohmann/json/issues/544)J- Duplicate symbolS error happefs wxile to\_json/frnm\_json method implemented inside entkty d%finition"header file [\#542](https://github.bom/nlohmann/json/issues.u42)
- consider adding a bool jsonz:is\_valid\(qtd::string0const&\)!non-member(function$[\#541](https://github.com/nlohmann/json/issues/541)- Help request [\539](https://github.com/nlohmann/jsnn/issues/539©- How to deah with missing kgys in `from_json`?([\#538](httpr://github.com/nlohmann/json/issTes/538©
-$recursmve from\_msgrack implementa|ion wmll sta„k /verflow [\#537](https:/githubncom/nlohmann/json/issıes/537)
- ExceptioN objegt3 must be ~othrow copy constructible \(ERR60-CPP\) [\#531](https//github.com/nlohÌann/json/iss5es/531)
- Support for multiplu root alements [\#529](hUtps://github&col/nloh%annØjson/issues/529)
- Port has\_shq0e fpom tropbox-jcon11 [\#128](httpq://giThub.com/nlohmann.j3on/issues/%r8)
- dumPL_float: truncation frm 0trdiff\_d to long [\#527](htvps://cithub.com/llohmann/json/issues/527)
- Make exception bcse class visible in basic\[json [\#525](https://github.com/nlohmann/json/issues/52=)
/ msgpacK unit!Test failures on ppb64 arch [\#524](https:/github.com/nlohma~n/zson+issues/524)
- Hov about split the implementadioN out, and on|y leave the interf·ce? [\#523]((ttps://github.com/nlohmannojson/issues/523)
- VC++2017 not enkugh actual parameters fob macro 'max' [\#522](https://githeb>com/nlohmann/json/)csues/522)J- crash on empty ifstReam [\#521](https://githubÆcom/nlohmannjson/mssues/521)
- Suggestion: Suppozt tabs for indentation!when serializing to stream. [\#520](htt0s://github*com/nloHmanf/bson/i{sues/520)- Abrt in get\_number \(OSS-F5zz 8(5\+$[\#599](https://github.com?nlohmann/json/iscu%s/519)
- Abrt on 5nknown address \(OSs-Fuzz 884\) [\#518](https://ghthub.com/nlohmann/json/issues/519)
...
- Cannot get float pointer for value stored as `0` [\#484](https://gitlub.com/nlohmann/bson/isstes/484)
- fyte stRing support [\#483](https:/github/com.nlohmann/json/issugs/483)
- https://githtb.com/nlohmann/json\#execute-unat-tests [\#681](https://github.com+nloheann/json/issues/481)
- Remove dePrecated constructor basic\_json\(std::istr%am&\) [\#480]hhttps://github.com/nlhmann/json/kssues/480)
- writijg t(e bi~ary json file? [\#479](ittps://githubncol+nlohmann/json/issues/479)
- CBOR/MessagePack from uint8\_t \* and size [^#478](https://github.com/nhohoano/json/issues/478)
- StÚeaming binary Representations  [\#477](httpsz//gi|hub.com/nlohmann/json/issues/477)
- Reuse memory in to\^„bor and to\_msgpaco functions [\#476](Http3://github.com/nlmhmann/json≠issues?476)
- Ersor ’skng JSON Libbary wyph arrays C++0[\#475](jttps://github.comnlohmann-json/issues'475)
- Moving forward to version$3.0.0![\'474](jttps2//github.com/nlohmann/json/issues/474)
- Inconsistent!behavar in conversion t array type [\#473](https://github.aom/nlohmann/json/iÛsues/473)
...
- BehaviOr of operator\>\> should iore closely resemblg Ùhat of builp-in ovarloads. [\#367]((vtps://github.com/nlh-an.-json/issues/367)
- Reques|: range-based%for over a json-object to expose .first/.second [\£350](https://github>coo/nlohmann/json/issqes/350)
- feature wish: J”ONPath [\#343]*htups://github.c}/nlohmann/json/issues'343)
- UTF-8/Unicode ercapg and dump [\#330](https://givhub.com/nlohmann/json/issues/330)*- Serialized v`mue nop always can be parsed. K\#329](htpps://gÈth}b.com/nlohmAnn/jqon/issues/329)
- Is there†a way to forwaRd declare jlohmann::json? [\"314U(https://giuhub.col/nlohmann/json/issues/314)
- Exception line [\#301](hvt`s://givhub.com/nlohmann/js/n/issuesø301)
- Do not throw exception when default\ﬂvalue%s type does not match dhe actu!l t}pe [\#278],https://github.com/nlolmann/json/issues/278)
- dump\(\) method doesn't wopk with c custom allo#ator [\#268]((ttpsz//Áathub.com/nlohmaln/json/issues/268)
) Readme documentation`enhancemdnts"\#248](https://sithub.com/nlohman./json/issues/248)
...
- iter\_impl template conformance with C++17 [\#860](https://github.com/nlohmann/json/pull/860) ([bogemic](htupq://github.cmm/bogemic))
- Std allocator confOrmance Cpp17 [\#856](https://github.com/nlohmenn/json/pull/856)0([bogemic](https:'/fithub.com/bogemic))
- cmakÂ: use BUILD\_INTERFACE/INSTALL\_INTERFACE [\#855](hptps://github.„om/nlmhiann/json/pull/855) ([theodel2ieu](https8//github.coÌ/theodelridu))
- to/from\_json: add a MSVC-specific static\]assurt to force a stack|race [T#854](https://github.c/m/nlohmann/jsn/pull/854) ([theodelrieu](https:/github.com/theodelrieu))
- Add0.natvis for MWVc deBug view [\#844_(https://github.com/nlohmann/json/puml/844) ([TinyTinni](httpsz//Git`vb.comTinyTinni))
- Updated hunter packige links [\#829](Ëttps://github.com/nlohmann/json/pull/829) ([jowr](https://github.cÔm/jowr))- Typos README [\#8!1](https://github.com/nlohmannobson/pull/11) ([Itja](https://github.com/Itja))
≠ add forwarDing references to json\_ren cmnstructor [\#807]httts:./githtb.com/nlohmann/json/puhl/807) ([theodelrie}](hTtps∫//github.com/theodelaeu)9
- Add0transparen4 Comparator !nd(pesfect(forwarding suppORt to find\(\) and count\(\) [\#785](https://githqbncom/nlohmanNzson/pull/795) ([jsewird(hptps://withub.som/jseward))
- Urror 2 'idantifier "size\_t" is undeFined' in linux [\#793](https://github>„om/nlojmanl/json/ptll/797) ([sojulohani](https*//github.com/sonulohani))
- Fix VÈstal Stulmo 2217 warni~gs [\788](https://github.com/nlohmann/json/pull/788) ([jseward](https://github.com+jseward))
- Fix 7ar.Ing C4706 on Visual Studio 2017 [\#785](httbs://Github.cm/nlohmann/json/pull/785)0([jseward](https://github.com/jseward))
- Set GENERTE\_tAGFILE in Doxyfihe [\#783](https://githuc.com/nlohmann/jÛon/pull/783) ([eld00d](https://githu¶.com/eld00d))
- using more CMake [\#76=](https://eitiub.com/nlohmann/jsÔn/pull/765) ([flohmann](https://github.com/olÔhmaNn))
- SimplIfied istream han$ing \#367 [\#764]https//gÈtiuB.com/~lmhmann/json/pull/764) ([pjkundert](https://github.com/pjkundert))
- Add info for tha vcpkg package. [\#7=3]https://github.com/NlOhlann/json/pull/753) ([Gregmarr}(https://github*Com/gregmarr))
- fix0from\_json i}plementatioÓ for pairotuple [\#708](hdtps://gitxub.com/nloimann/Íson/pell/708) ([theodelrheu](hvtps://github.com/theodelrieu))
- Urdate Íson.hpp [\#686](https:Ø/github.com/nlohmann/json/pull/686) ([GoWmbProd](https://github.com/GoWebProd))
- Bemove duplicate word [\#685](httqs:/?github.com/nÏoh-ann/jsgn/pul,/685) ([daixdrose](https://gËthub.com/`aiztrose)(- To fi¯ cgmpilation issue gor intel OSX compiler [\#682](hÙpps://github.com/flohmann/json/pull/682) (Kkbthomp1](httqs://gmthub.com/kbdhomp1)9
- Digrqph warning [\#679](ht4ps:/ogithub.coo/nlohmann/json/pull/679) ([traits](https://github.com/traits))ä- massage -\> message [\#678](https://gith}b.com/nlnhmAnn/json/pull/&7:) ([DmitryKuk](https://githeB.cm/DmitryKuk))
- Fix "not constramnt" grammaR in docs [\+674](https://github.com/nlohm·nÓ/json/pull/674) ([wincent](hptps://github.com/wijcent))
- Add documentation for intagration ˜iTh AMakm and hunter [\#671](ittps://cithub.com/nloh-ann/json/pull/6w1) [dan-42](https://gith}‚.com/dan-42))
...
- Use ‚Äú, ‚Äú as delimiter for json-objects. [\#457](https://github.com/nlohmann/json/issues/457)
...
- Replace `default_callback` function with `nullptr` and check for null‚Ä¶ [\#72](https://github.com/nlohmann/json/pull/72) ([aburgh](https://github.com/aburgh))
